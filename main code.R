...
#https://github.com/justusfrantz/capstone/blob/master/main%20R%20codes.R
...
library(parallel)
library(wordcloud)
con1 <- file("C:/Users/Sheetal/datasciencecoursera/capstoneproject/Coursera-SwiftKey/final/en_US/en_US.twitter.txt", open = "rb")
twitter <- readLines(con1, skipNul = TRUE, encoding="UTF-8")
close(con1)

con2 <- file("C:/Users/Sheetal/datasciencecoursera/capstoneproject/Coursera-SwiftKey/final/en_US/en_US.news.txt", open = "rb")
news <- readLines(con2, skipNul = TRUE, encoding="UTF-8")
close(con2)

con3 <- file("C:/Users/Sheetal/datasciencecoursera/capstoneproject/Coursera-SwiftKey/final/en_US/en_US.blogs.txt", open = "rb")
...
writeLines(SampleAll, "C:/Users/Sheetal/datasciencecoursera/capstoneproject/Coursera-SwiftKey/final/en_US/sampleall/SampleAll.txt")


##Data Cleaning

##Next, the corpus was converted to lowercase, strip whie space, and removed punctuation and numbers.
...
SampleAll <- VCorpus(DirSource("C:/Users/Sheetal/datasciencecoursera/capstoneproject/Coursera-SwiftKey/final/en_US/sampleall/", encoding = "UTF-8"))
...
write.csv(quadgram[quadgram$freq > 1,],"C:/Users/Sheetal/datasciencecoursera/capstoneproject/ShinyApp/quadgram.csv",row.names=F)
quadgram <- read.csv("C:/Users/Sheetal/datasciencecoursera/capstoneproject/ShinyApp/quadgram.csv",stringsAsFactors = F)
saveRDS(quadgram,"C:/Users/Sheetal/datasciencecoursera/capstoneproject/ShinyApp/quadgram.RData")
...
write.csv(trigram[trigram$freq > 1,],"C:/Users/Sheetal/datasciencecoursera/capstoneproject/ShinyApp/trigram.csv",row.names=F)
trigram <- read.csv("C:/Users/Sheetal/datasciencecoursera/capstoneproject/ShinyApp/trigram.csv",stringsAsFactors = F)
saveRDS(trigram,"C:/Users/Sheetal/datasciencecoursera/capstoneproject/ShinyApp/trigram.RData")
...
write.csv(bigram[bigram$freq > 1,],"C:/Users/Sheetal/datasciencecoursera/capstoneproject/ShinyApp/bigram.csv",row.names=F)
bigram <- read.csv("C:/Users/Sheetal/datasciencecoursera/capstoneproject/ShinyApp/bigram.csv",stringsAsFactors = F)
saveRDS(bigram,"C:/Users/Sheetal/datasciencecoursera/capstoneproject/ShinyApp/bigram.RData")